...
This repository is created as an updated example of good open data practice and F.A.I.R.+T. principles. Its direct copy is archived on [Figshare](https://figshare.com/) under [doi:UPDATE](https://doi.org/10.6084/m9.figshare.21407445). 
...
This repository including paper and data evaluation script are authored by all students attending the [Czech-Bavarian Mini-school 2022](https://mini-school.eu/):  
