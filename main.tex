...
\author{Lukas Bauer}
\affiliation{Forschungszentrum Jülich GmbH, Jülich, DE}
%\email{l.bauer@fz-juelich.de}

\author{Anežka Bendová}
\affiliation{Charles University, Faculty of Mathematics and Physics, Prague}
...
\author{Octavio Emmanuel Hernández Alvarez}
\affiliation{Charles University, Faculty of Mathematics and Physics, Prague}
%\email{octavio.hernandezaz@udlap.mx}

\author{Štefan Hricov}
\affiliation{Charles University, Faculty of Science, Prague}
...
\affiliation{Technical University of Ko\vcice, Ko\vcice, Slovakia}
...
\author{Brian R. Pauw}
\affiliation{Bundesanstalt für Materialforschung und Prüfung, Berlin, Germany}
%\email{Brian.Pauw@bam.de}

\author{Klaudie Ramszová}
\affiliation{Charles University, Faculty of Mathematics and Physics, Department of Condensed Matter Physics, Czech republic}
%\email{ramszovk@natur.cuni.cz}
